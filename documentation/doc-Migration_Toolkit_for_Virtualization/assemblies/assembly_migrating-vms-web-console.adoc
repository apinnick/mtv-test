...
You must add an {virt} and a VMware provider in the web console.

:migrating-vms-web-console!:
:context: virt-provider
:virt-provider:
include::../modules/Adding-provider.adoc[leveloffset=+2]
:virt-provider!:
...
:context: network
:network:
include::../modules/Creating-mappings.adoc[leveloffset=+2]
:network!:
:context: storage
:storage:
include::../modules/Creating-mappings.adoc[leveloffset=+2]
